<?php  
    ...
    require 'scripts/sys_register_auth_require.php';
    header("Cache-conrol:no-cache,must-revalidate");
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Demo Website form AdminLTE</title>
    ...
    <body class="skin-black">
        ...
        <header class="header">
            <a href="index.php" class="logo">
                ...
                <img src="img/LogoHead.png"class="mylogo" >
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo $obj_->getuser_fullname() ?> <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
                                    <?php echo $obj_->getuser_fullname() ?> 
                                        <small><?php echo $obj_->getEmail() ?> </small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p><?php echo "HEllo" ; echo $obj_->getuser_id() ?> </p>
